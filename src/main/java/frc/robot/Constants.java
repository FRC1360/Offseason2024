...
public final class Constants {
  ...
  public static final double SPEAKER_HEIGHT = Units.inchesToMeters(95);
  public static final double SHOOTER_HEGHT = Units.inchesToMeters(10);
  ...
  public static class ShooterConstants {
    ...
    public static final double SHOOTER_SHOOT_SPEED = 3250;
